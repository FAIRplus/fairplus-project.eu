<?php
  $title = "Accessibility | FAIRplus project";
  $description = "The accessibility statement of the FAIRplus project website";
...
<p>The FAIRplus is a short-term, collaborative effort so unfortunately we do not have the resources to hire an accessibility expert. However, our community includes professional web developers, who assess the accessibility of the site using:</p>
...
<p>The website was last assessed on 14 April 2021.</p>
